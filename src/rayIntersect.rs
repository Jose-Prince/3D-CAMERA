...
impl RayIntersect for Sphere {
    fn ray_intersect(&self, ray_origin: &Vec3, ray_direction: &Vec3) -> bool {
        ...
        // It represets the squared distance from the ray origin to the sphere center minus the squared radius
        let c = dot(&oc, &oc) - self.radius * self.radius;

        // Discriminant of the quadratic equation
        // discriminant = b² - 4ac 
        // The discriminant determines the number of solutions to the quadratic equation
        // If the discriminant is greater than zero, the ray intersects the spher at two points
